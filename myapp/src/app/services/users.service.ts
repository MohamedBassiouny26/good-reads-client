...
export class UsersService {
  ...
  readonly baseURL: string = "https://iti-good-reads.herokuapp.com/users";
  readonly userBooks: string = "https://iti-good-reads.herokuapp.com/users/606623d776e86ac9ad8902fd/books";
  readonly catURL: string = "https://iti-good-reads.herokuapp.com/categories";
  readonly authURL: string = "https://iti-good-reads.herokuapp.com/authors";
  readonly bookURL: string = "https://iti-good-reads.herokuapp.com/books";
